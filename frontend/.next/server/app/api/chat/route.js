...
IMPORTANT: Use ONLY the actual data provided above. Never use placeholder text or make up information.`};async function h(e){try{if(!(await (0,l.$1)()).enableChatbot)return new Response("Chatbot disabled",{status:403});if(!process.env.OPENAI_API_KEY)return new Response("OPENAI_API_KEY is not configured",{status:503});let{messages:t}=await e.json(),o=await p(),r=new s.Pp({apiKey:process.env.OPENAI_API_KEY}),a=await r.chat.completions.create({model:"gpt-4",messages:[{role:"system",content:o},...t],stream:!0}),i=new TextEncoder,n=new TransformStream,u=n.writable.getWriter();return(async()=>{try{for await(let e of a){let t=e.choices[0]?.delta?.content||"";t&&await u.write(i.encode(t))}}catch(e){console.error("Streaming error:",e)}finally{await u.close()}})(),new Response(n.readable,{headers:{"Content-Type":"text/plain","Transfer-Encoding":"chunked"}})}catch(e){return console.error("Chat Error:",e),new Response("Error processing chat",{status:500})}}async function d(e){if(!(await (0,l.$1)()).enableChatbot)return new Response("Chatbot disabled",{status:403});if(!process.env.OPENAI_API_KEY)return new Response("OPENAI_API_KEY is not configured",{status:503});let{searchParams:t}=new URL(e.url),o=t.get("text");if(!o)return new Response("Text parameter is required",{status:400});try{console.log("Generating speech for text:",o);let e=await fetch("https://api.openai.com/v1/audio/speech",{method:"POST",headers:{Authorization:`Bearer ${process.env.OPENAI_API_KEY}`,"Content-Type":"application/json"},body:JSON.stringify({model:"tts-1",voice:"onyx",input:o,response_format:"mp3"})});if(!e.ok){let t=await e.text();throw console.error("OpenAI TTS API error:",t),Error(`OpenAI TTS API error: ${t}`)}console.log("Speech generated successfully");let t=await e.arrayBuffer();return new Response(t,{headers:{"Content-Type":"audio/mpeg","Cache-Control":"no-cache"}})}catch(e){return console.error("Error generating speech:",e),new Response("Error generating speech",{status:500})}}let f=new a.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/chat/route",pathname:"/api/chat",filename:"route",bundlePath:"app/api/chat/route"},resolvedPagePath:"C:\\Users\\henry\\cursourProjects\\ofolio\\frontend\\app\\api\\chat\\route.ts",nextConfigOutput:"standalone",userland:r}),{requestAsyncStorage:g,staticGenerationAsyncStorage:b,serverHooks:m,headerHooks:y,staticGenerationBailout:v}=f,w="/api/chat/route";function k(){return(0,n.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:b})}},12129:(e,t,o)=>{o.d(t,{$1:()=>n,aJ:()=>s,xY:()=>u});var r=o(94390),a=o(50033);let i={id:1,enableBackground:!0,enableChatbot:!1,enableContactForm:!1,activeBackgroundPackId:null,backgroundConfig:{},backgroundQuality:"med",reducedMotionOverride:null,siteTitle:"Portfolio",tagline:"",aboutContent:"",avatarImageUrl:null,logoImageUrl:null};async function n(){try{let e=await r._.siteSettings.findUnique({where:{id:1}});if(!e)return a.IA.parse(i);return a.IA.parse({...e,backgroundConfig:e.backgroundConfig??{}})}catch(e){return console.error("Failed to load SiteSettings:",e),a.IA.parse(i)}}async function s(){try{let e=await r._.siteSettings.findUnique({where:{id:1},include:{activeBackgroundPack:!0}});if(!e)return{settings:a.IA.parse(i),activePack:null};return{settings:a.IA.parse({...e,backgroundConfig:e.backgroundConfig??{}}),activePack:e.activeBackgroundPack??null}}catch(e){return console.error("Failed to load SiteSettings with pack:",e),{settings:a.IA.parse(i),activePack:null}}}async function u(e){let t=a.Zd.parse(e);t.backgroundConfig&&"object"!=typeof t.backgroundConfig&&(t.backgroundConfig={});let o={...t,backgroundConfig:t.backgroundConfig},n={...i,...t,backgroundConfig:t.backgroundConfig??i.backgroundConfig};try{let e=await r._.siteSettings.upsert({where:{id:1},create:n,update:o});return a.IA.parse(e)}catch(e){throw console.error("Failed to update SiteSettings:",e),e}}}};var t=require("../../../webpack-runtime.js");t.C(e);var o=e=>t(t.s=e),r=t.X(0,[499,24,236,50,923],()=>o(70568));module.exports=r})();